...
namespace WindowsFormsApp1
{
    public partial class Form10 : Form
    {
        ...
        public Form10()
        {
            ...
            dataGridView1.Columns[4].Name = "kabinet";
        ...
        {
            string sql = "INSERT INTO departments (id, name, company_id, salary, kabinet) " +
        ...
        {
            string sql = "DELETE FROM departments WHERE id =" + textBox1.Text + ";";
            cmd = new SqlCommand(sql, connection);
            try
            {
                connection.Open();
        ...
        {
            string sql = "UPDATE departments SET name='" + textBox2.Text + "', company_id='" + textBox3.Text + "', salary= '" + textBox4.Text + "', kabinet= '" + textBox5.Text + "' WHERE id = " + textBox1.Text + ";";
            cmd = new SqlCommand(sql, connection);
            try
            {
                connection.Open();
